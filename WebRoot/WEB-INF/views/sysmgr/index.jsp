  	...
  	<div id="main">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						%>
							...
							<ul class="dropdown-menu">
								<li><a href="${ctx}/index/updateInfoFace" target="mainFrame">个人信息</a></li>
								<li><a href="${ctx}/index/updatePwdFace" target="mainFrame">修改密码</a></li>
		...
		<div id="content" class="container-fluid">
			<div class="row-fluid">
				...
				<div id="right">
					<iframe id="mainFrame" name="mainFrame" src="${ctx}/index/newsMgr" style="overflow: visible;" scrolling="yes" frameborder="no" width="100%" height="600"></iframe>
				</div>
			</div>
		</div>
	</div>
